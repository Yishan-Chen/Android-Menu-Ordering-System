...
%>
 ...
 <body>
    ...
    <table align="center" border="0" width="40%">
     <form name="changePwd" action="funtionServlet" method="post">
      <tr bgcolor="eeffee" height = 30px>
       <td align="right" >登录名</td>
       <td><input type="text" name="adname" size="19"></td>
      </tr>
      <tr bgcolor="ffeeff" height = 30px>
